  ...
  <div class="tabs-content">
    ...
    <div class="tabs-container" id="tab3C">
      ...
      <form class="form-contact" id="save-list">
        ...
        <!-- last wrapper -->
        <div id="formresult" class="wrapper">
          <div class="form-group text-left">
             <label class="col-md-12 row">FORM URL&nbsp;&nbsp;<a class="icon-copy btn-copy"></a></label>
             <input id="linkcopy" type="text" class="form-control-lg" />
          </div>
...
<script type="text/javascript">
    ...
    $("#save-list").submit(function(e){
      ...
      $.ajax({
        ...
        success : function(result){
          ...
          $(".act-tel-tab .message , #formresult").show();
          $(".icon-copy").attr('data-link',result.link);
          //$(".structure-form").attr('data-link',result.link);
          //$("#structure-form").val(result.link);
          $("#linkcopy").val(result.link);
          alert(result.status);
          clearForm();
        }
      })
  ...
  function clearForm(){
      ...
      $("input[name='labelname'], textarea[name='pixel']").val('');
  }
