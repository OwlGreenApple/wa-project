    ...
    <div class="offset-sm-2 col-sm-8">
      ...
      ">
        <div class="card-body">
          ...
          <p class="pg-title">@if(!is_null($order)) Berikut adalah no order anda #{{$order->no_order}} . @endif Setelah Anda menyelesaikan langkah-langkah konfirmasi berikut, segera lakukan pembayaran untuk mendapatkan akses langsung ke akun Omnilinkz Anda!</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-sm-4">
        <div class="card h-80">
          <div class="card-body">
            ...
            <p class="card-text">Terima Kasih telah memilih Omnilinkz. Cek pesan di inbox email yang telah anda daftarkan.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="card h-80">
          <div class="card-body">
            ...
            <p class="card-text">Temukan pesan email yang dikirim oleh Omnilinkz mengenai konfirmasi pembayaran.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
